...
<p align="justify" style="font-size: 13pt">In content, this translation into English of Rudolf Steiner\'s lecture on the \
  ...
  <ul> \
	<li>be friendly and patient, \
	<li>be welcoming, \
	<li>be considerate, \
	<li>be respectful, \
	<li>be careful in the words that you choose and be kind to others, \
	<li>when we disagree, try to understand why. \
  </ul> \
  ...
  <ul> \
	...
	<li>Be respectful. Not all of us will agree all the time, but disagreement is no excuse for poor \
	behavior and poor manners. We might all experience some frustration now and then, but we cannot allow that frustration to turn into a personal attack. It's important to remember that a community where people feel uncomfortable or threatened is not a productive one. Members of the FreeBSD community should be respectful when dealing with other members as well as with people outside the FreeBSD community. \
	<li>Be careful in the words that you choose and be kind to others. Do not insult or put down other participants. Harassment and other exclusionary behavior aren't acceptable. This includes, but is not limited to: \
	...
	<li>In general, if someone asks you to stop, then stop. Persisting in such behavior after being asked to stop is considered harassment. \
